namespace SetupMonitor
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox1.Text = "BlackBerry Enterprise Services is being configured. Your system will restart when" +
    " the installation is completed. You will then need to reconnect your RDP session" +
    ".";
